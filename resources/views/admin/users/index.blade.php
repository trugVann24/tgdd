    ...
    <div class="flex items-center justify-between border-b border-gray-700 pb-3">
        ...
        {{-- <div class="">
            <a href="{{ route('admin.roles.create') }}"
                class="bg-indigo-700 px-3 py-2 rounded-sm font-inter-500 text-sm hover:bg-indigo-800">Thêm role</a>
        </div> --}}
    </div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        <thead>
                            <tr>
                                ...
                                <th scope="col"
                                    class="px-6 py-3 text-start text-xs font-inter-500 text-gray-500 uppercase">Email
                                </th>
                                <th scope="col"
                                    class="px-6 py-3 text-start text-xs font-inter-500 text-gray-500 uppercase">Role
                                </th>
                                <th scope="col"
                            ...
                            @foreach ($users as $user)
                                <tr class="">
                                    ...
                                    {{-- <td class="px-6 py-4 flex items-center justify-end font-inter-500 ">
                                        <div
                                            class="w-9 h-9 rounded-full hover:bg-gray-900 flex items-center justify-center">
                                            <a href="{{ route('admin.roles.edit', $user->id) }}" class="">
                                        ...
                                        <form action="{{ route('admin.roles.destroy', $user->id) }}" method="POST"
                                            ...
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="w-9 h-9 rounded-full hover:bg-gray-900"> <i
